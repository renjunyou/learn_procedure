...
<div class="divBody">
  <div class="divContent">
    ...
    <c:choose>
      ...
      <c:otherwise>
        <a href="${pb.url }&page=${pb.pc-1}" class="aBtn bold">上一页</a>
      </c:otherwise>
    </c:choose>
    ...
    <c:forEach var="pc" begin="${begin }" end="${end }">
      <c:choose>
        ...
        <c:otherwise>
          <a href="${pb.url}&page=${pc}" class="aBtn">${pc }</a>
        </c:otherwise>
      </c:choose>
    </c:forEach>
    ...
    <c:if test="${end < pb.tp }">
     ...
     <c:choose>
      ...
      <c:otherwise>
        <a href="${pb.url }&page=${pb.pc+1}" class="aBtn bold">下一页</a>
      </c:otherwise>
    </c:choose>   
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
